    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            children: [
              // Hızlı Aksiyon Kartı (Toplu Öğrenci Ekle)
              GlassCard(
                ...
                child: SizedBox(
                  ...
                  child: OutlinedButton.icon(
                    ...
                    icon: const Icon(Icons.file_upload_outlined, size: 20, color: AppColors.accent),
                    label: const Text('PDF & EXCELL', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold)),
                  ),
                ),
              ),
                            ...
                            child: AnimatedContainer(
                              ...
                              child: GlassCard(
                                ...
                                IconButton(
                                  ...
                                  tooltip: 'Veli Bağlantı Kartı & QR',
                                ),
                                // Düzenleme Butonu
                                IconButton(
                                  icon: Icon(
                                  ...
                                  onPressed: () => _openAddStudentDialog(context, student: student),
                                  tooltip: 'Düzenle',
                                ),
                                // Silme Butonu
                                IconButton(
                                  ...
                                  onPressed: () => _confirmDeleteStudent(context, ref, student.id!, student.fullName),
                                  tooltip: 'Sil',
                                ),
                              ],
                            ),
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              ...
              ref.read(studentListProvider(widget.classModel.id!).notifier).deleteStudent(studentId);
            },
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.of(ctx).pop();
              ref.read(studentListProvider(widget.classModel.id!).notifier).deleteStudentsBatch(selectedIds);
          ...
          return AlertDialog(
            ...
            actions: [
              ...
              ElevatedButton(
                onPressed: () {
                  Navigator.of(ctx).pop();
                  ref.read(studentListProvider(widget.classModel.id!).notifier).moveStudentsBatch(selectedIds, selectedClassId);
                  setState(() => _selectedStudentIds.clear());
                },
